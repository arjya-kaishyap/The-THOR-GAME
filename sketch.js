...
var thor1, villan5, strombreaker,gameover, background, powerUp, leader,sword,life;
var thor1Img,villan5Img, villan4Img, gameoverImg, backgroundImg, powerUpImg,leaderImg,swordImg,sword2Img,lifeImage;
...
function setup() {
   ...
   swordCheck = createSprite(25000,thor1.y+500,20,170)
...
function draw() {
	...
	count =1
	  ...
	  //console.log(frameCount);
	   ...
	   push();
	   image(lifeImage, width / 2 - 130, height - thor1.positionY - 400, 20, 20);
	   fill("white");
	   rect(width / 2 - 100, height - thor1.positionY - 400, 185, 20);
	   fill("#f50057");
	   rect(width / 2 - 100, height - thor1.positionY - 400, player.life, 20);
	   noStroke();
	   pop();
